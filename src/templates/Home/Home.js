      ...
      >
        <div className="Home__love-letters">
          <p className="Home__love-letters__paragraph">
            Thanks so much for all of your hard work on the flower arrangements,
            you did a spectacular job and they were gorgeous...the boutonnières,
            the arch, and everything in between were all magnificent and
            exceeded my expectations. I thought the boutonnières were adorable!
            Bouquets were so pretty, loved the orchids, all so beautiful!
          </p>
          <p className="Home__love-letters__paragraph">
        ...
        <div className="Home__love-letters">
          ...
          <p className="Home__love-letters__paragraph">
            ...
            romance!!! Everyone was so impressed with your work and I wanted to
            thank you for listening to what we wanted and then delivering our
            vision.
          </p>
          <p className="Home__love-letters__paragraph">
